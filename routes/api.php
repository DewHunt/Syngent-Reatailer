...
Route::get('sales/invoice',[OutSourceApiController::class, 'salesInvoice']);

Route::group(['middleware' => ['jwt.verify','cors']], function() {
    Route::post('retailer/product-stock',[OutSourceApiController::class, 'retailerProductStocks']);
    Route::get('retailer/get-product-stock',[OutSourceApiController::class, 'getRetailerProductLists']);
    ...
    Route::get('getCategoryList',[OutSourceApiController::class, 'getCategoryList']);
    ...
    Route::get('topTenSalesReport',[OutSourceApiController::class, 'topTenSalesReport']);
...
Route::get('getAppInfo',[OutSourceApiController::class, 'getAppInfo']);
