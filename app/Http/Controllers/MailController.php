...
class MailController extends Controller
{
	...
	public function basic_email() 
	{
		...
		$data = array('name'=>"Saidul Haque Sayed",'email'=>'sayedmyn@gmail.com','phone'=>'01829601101');
		\Mail::send(['text'=>'mail'], $data, function($message) {
			$message->to('sayed.giantssoft@gmail.com', 'Giants Soft')->subject('Laravel Basic Testing Mail');
			$message->from('sayed.giantssoft@gmail.com','Saidul Haque Sayed');
		});
	...
	public function html_email() 
	{
		...
		Mail::send('mail', $data, function($message) {
			...
			$message->from('demoadmin@example.com','Saidul Haque Sayed');
		});
	...
	public function attachment_email() 
	{
		...
		Mail::send('mail', $data, function($message) {
			...
			$message->attach('https://example.com/retail_gear/public_html/retail_gear/public/laravel.pdf');
			$message->from('demoadmin@example.com','Saidul Haque Sayed');
		});
	...
	public function mail_attachment_email(Request $request) 
	{
		...
		Mail::send('mail', $data, function($message) use ($data)
		{
		    ...
		    $message->from('demoadmin@example.com');
