    ...
    <div class="row">
        ...
        <div class="col-md-10" style="margin-right: 0px !important;margin-left: 0px !important;padding-right: 0px !important;">
            <a href="{{ route('prebooking.expire') }}">
                <button  type="button" class="btn btn-success pull-right btn-sm pre-booking-btn" style="margin-left:5px;">Expire Pre-Booking</button></a>
...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group" style="widht:200px">
            <input type="text" name="serach" id="serach" class="form-control searchBtn"/>
        </div>
    </div>
</div>
    ...
    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th class="sorting text-right" data-sorting_type="asc" data-column_name="minimum_advance_amount" style="cursor: pointer;">Minimum Prebooking Amount</th>
            ...
            <form class="form-horizontal" method="POST" action="{{route('prebooking.add')}}" id="AddProductPreBooking">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <label>Model <span class="required">*</span></label>
                            <select class="select2 form-control get_product_model" data-placeholder="Select  Model" style="width: 100%;" name="product_model" required="">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="number" name="price" class="form-control setPrice"/>
                            <span class="text-danger">
            ...
            <form class="form-horizontal" method="POST" action="" id="UpdateProductPreBooking" >
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <label>Model <span class="required">*</span></label>
                            <select class="select2 form-control getModel get_product_model" data-placeholder="Select  Model" style="width: 100%;" name="product_model">
                                <option value="">Select Model</option>
                                @if(isset($modelList))
                                    @foreach($modelList as $row)
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            <label>MSRP <span class="required">*</span></label>
                            <input type="number" min="0" name="price" class="form-control setPrice"/>
                            <span class="text-danger">
...
jQuery('.pre-booking-toggle-class').change(function(e) {
    ...
    jQuery.ajax({
        ...
        success:function(response){
            if(response.success){
                Notiflix.Notify.Success( 'PreBooking Update Successfull' );
            }
...
jQuery('#AddProductPreBooking').submit(function(e) {
  e.preventDefault();
  jQuery('.get_product_model').html("");
  jQuery('.setPrice').html("");
  ...
  jQuery.ajax({
    ...
    success:function(response)  {
        ...
        if(response == "error") {
            Notiflix.Notify.Failure('PreBooking Insert Failed');
        }

        if(response == "success") {
            jQuery("#AddProductPreBooking")[0].reset();
            jQuery(".btnCloseModal").click();
            Notiflix.Notify.Success('PreBooking Insert Successfull');
...
jQuery(document).on("click","#editPreBookingInfo",function(e){
    ...
    jQuery.ajax({
        ...
        success:function(response)  {
            ...
            jQuery('.setPrice').val(response.price);
            jQuery('.ApiproductId').val(response.product_master_id);
            ...
            jQuery(".get_product_model").val(response.product_master_id).trigger('change');
...
jQuery(document).on("change",".get_product_model",function(e){
  e.preventDefault();
  $('.setPrice').val(0);
  $('.ApiproductId').val(0);
