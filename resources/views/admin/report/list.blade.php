...
<div class="col-md-12 mB-10">
    <div class="row">
        ...
        <div class="col-md-10 beforeAddBtn">
            {{-- 
            <button  type="button" class="btn btn-primary pull-right btn-sm newAddBtn" data-toggle="modal" data-target="#AddRetailerModal">Add Retailer</button> 
            --}}

            <button  type="button" class="btn btn-primary pull-right btn-sm newAddBtn" onclick="AddAllRetailerByApi()">
    ...
    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
        <thead>
            <tr>
                ...
                <th class="sorting" data-sorting_type="asc" data-column_name="phone_number" style="cursor: pointer; width:15%">Phone</th>
...
<div class="modal fade" id="viewRetailerDetailsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                 <table class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" id="retailerResultInfo">
                </table>
            </div>
            <div class="modal-footer">
