        ...
        <div class="bgc-white p-20 bd new-bp-css">
            ...
            <form method="post" action="{{ url('modelSalesReport') }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-2 bp-col-xs" style="padding: 0px 5px;">
                        ...
                        <input type="text" class="form-control datepicker" name="start_date" value="{{ date('Y-m-01') }}">
                    </div>
                    ...
                    <div class="col-md-2 mb-3 bp-col-xs" style="padding: 0px 5px;">
                        <button type="submit" class="btn cur-p btn-primary btn-block btn-float csearch">Search</button>
                    </div>
                    {{-- 
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <button class="btn btn-info cur-p btn-xs exportbtn" onclick="ExportToExcel('xlsx')">TO Excel</button><br/>
            ...
            <div class="table-responsive">
                <table id="dataExport"  class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" style="text-align: center;">
                    <thead>
                        <tr>
                            <th class="sorting" data-sorting_type="asc" data-column_name="id">Sl. <span id="id_icon"></span></th>
                            <th class="sorting" data-sorting_type="asc" data-column_name="product_model">Model Name</th>
                            <th class="sorting" data-sorting_type="asc" data-column_name="saleQty">Total Sale Qty</th>
                            <th>Sale Details</th>
                        </tr>
                    </thead>
                    <tbody>
                        @include('admin.report.seller_product_sales_result_data')
                    </tbody>
                </table>
