...
<div class="row">
    <div class="form-group col-md-4 bp-col-sm">
        <a href="javascript:void(0)" class="btn btn-primary cur-p btn-xs mbtnSearch exportbtn" id="exportExcel">Export to Excel</a>

        <a href="javascript:void(0)" class="btn btn-info cur-p btn-xs mbtnSearch exportbtn" id="exportPdf">Export to Pdf</a>
    </div>
