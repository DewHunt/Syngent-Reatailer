            ...
            <form method="POST" action="{{ url('award.add') }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 bp-add-incentive-9">
                        <select class="select2" multiple="multiple" data-placeholder="Select Category" style="width: 100%;" name="group_category_id[]" required="">
                            ...
                            @else
                                ...
                                @if(isset($retailerList))
                                    @foreach($retailerList as $row)
                                        <option value="{{ $row->retailer_id }}">{{ trim($row->retailer_name) }} -{{ $row->phone_number }} - {{ $row->retailder_address }}</option>
                                    @endforeach
                                @endif 
                                --}}

                                <input type="text" id="get_retailer_search" placeholder="Search Retailer By Name Or Phone Number" class="form-control"/>
                                <select class="form-control" name="incentive_type[]" id="set_retailer_search" multiple="multiple" style="display:none">
                                </select>
                            @endif    
                ...
                {{-- 
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Incentive Retailer</label>
                    <div class="col-sm-6">
                ...
                {{-- <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Incentive Retailer</label>
                    <div class="col-sm-6">
                        <input type="text" id="test_retailer_search" class="form-control"/>
                        <select class="form-control" name="retailer_search[]" id="set_retailer_search" multiple="multiple">
                            <option value="cheese">Select Retailer</option>
                        </select>
                    </div>
                </div> --}}
...
<script src="{{ asset('public/admin/multiselect/multiselect.js') }}"></script>
@endsection
