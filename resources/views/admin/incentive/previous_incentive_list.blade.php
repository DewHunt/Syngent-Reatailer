...
<div class="row">
@if(isset($groupId) && !empty($groupId) && $groupId == 1)
    <div class="col-md-9">Brand Promoter Previous Incentive List</div>
@else
    <div class="col-md-9">Retailer Previous Incentive List</div>
@endif
    <div class="col-md-3">
...
<div id="tag_container" class="table-responsive">
    <table class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
        ...
        <tbody>
            @include('admin.incentive.incentive_previous_result_data')
        </tbody>
    </table>
