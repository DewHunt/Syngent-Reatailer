...
<div class="col-12 col-md-12 col-sm-12 col-xs-12 peer pX-40 pY-50 h-100 bgc-white pos-r minMobWidth reset-login">
	...
	<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 beforelogin">
			...
			<input type="hidden" name="token" value="{{ $token }}">
				<div class="form-group aferFormPT" style="display:none">
					<label class="text-normal text-dark commonFontSize">{{ __('E-Mail Address') }}</label>
				...
				<div class="form-group aferFormPT">
					<label class="text-normal text-dark commonFontSize">{{ __('Confirm Password') }}</label>
					<input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password">
				</div>
				<div class="form-group">
					<div class="peers ai-c jc-sb fxw-nw">
						<div class="peer"><button class="btn btn-primary mobbtn">{{ __('Reset Password') }}</button></div>
					</div>
				</div>
			</form>
		</div>
